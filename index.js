    ...
    <div class="box" id="infoBox2">
        ...
        <div class="slider-container hidden" id="sliderContainer2">
            ...
            <p id="moreInfo2" class="hidden">
                Du sparar ungefär <b><span id="waterSavings2">0</span> liter vatten per duschtillfälle</b> genom att korta ner din duschtid med <span id="sliderValue2">0</span> minuter.
            </p>
        </div>
    </div>
